function outdata = awfm_triangles_pulses(t, ss_v, rest_t, rmphght, rampt, nramps, stp_upt, stp_dwnt, nstps, frststp_hght, stpdlta)
% [DEFAULTS]
% ss_voltage, 0, V
% rest_t, s
% rmphght, 1, V
...
outdata = [rest_period, ramps_period, rest_period, steps_period, rest_period];
