function y = awfm_pulses_clustered(t, low_v, high_v, dlta, up_t, down_t, nstps, nperstep, delay, repeat)
...
for i = 1:nstps
    y = [y, repmat([(low_v + zeros(1, downsamps)), ((high_v + (i - 1) * dlta) + zeros(1, upsamps))], [1, nperstep])];
end
