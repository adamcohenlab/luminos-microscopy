function outdata = awfm_ramp_pulse(t, ss_v, rest_t, rmphght, rampt, stp_upt, stp_dwnt, nstps, frststp_hght, stpdlta)
...
outdata = [rest_period, ramp_period, rest_period, steps_period, rest_period];
