...
function y = dwfm_theta_burst_2(t, pulsnum, timss, freq1, freq2, repeat_freq2, freq3, t_before)
...
pulsnum = defcheck(pulsnum, 5); %number of pulses
freq1 = defcheck(freq1, 100);
timss = defcheck(timss, 0.1); % this might be pulse width, but unsure?
amp1 = 1;
