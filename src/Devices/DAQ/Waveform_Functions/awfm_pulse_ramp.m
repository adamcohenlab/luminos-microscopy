function outdata = awfm_pulse_ramp(t, ss_v, rest_t, stp_upt, stp_dwnt, nstps, frststp_hght, stpdlta, rmphght, rampt)
...
outdata = [rest_period, steps_period, rest_period, ramp_period, rest_period];
