classdef DCServo_TCube < Motion_Controller
    ...
    properties (Constant, Transient)
        ...
        C_DLL_ONE = 'ThorLabs.MotionControl.TCube.DCServo.dll'
    ...
    methods
        function obj = DCServo_TCube(Initializer, options) % Instantiate motor object
            arguments
                Initializer;
        ...
        function updatestatus(obj) % Update recorded device parameters in matlab by reading them from the devuce
            obj.isconnected = boolean(obj.deviceNET.IsConnected()); % update isconncted flag
