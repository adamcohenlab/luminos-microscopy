function [alp_pattern_data, bincode] = hadamard_patterns_constant(nblock_and_step, projection_element, super_mask)
...
xspat = repmat( ...
    ...
    ceil([device_rows / nblock, device_cols / nblock]./projection_element));
