function stackImgs = RoundRobin(inputStack, mode, inhRatio)
% default
ratio = 0.1;
...
if isempty(find(strcmp(mode, 'inh'))) == 0
    ...
    for i = 1:size(inputStack, 3)
        ...
        stats1 = regionprops(logical(inputStack(:, :, i)));
        ...
        stats2 = regionprops(logical(fullMask));
...
elseif isempty(find(strcmp(mode, 'ext'))) == 0
