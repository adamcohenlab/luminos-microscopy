...
// Adapted by F. Phil Brooks III from sample code on Microsoft Documentation Page (MIT license).
// Used to allow run-time checking for SSE vector instruction support by CPU by querying boolean properties of InstructionSet
// e.g. 
