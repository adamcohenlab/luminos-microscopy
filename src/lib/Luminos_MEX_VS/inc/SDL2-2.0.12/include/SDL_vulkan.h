 ...
 *
 *  \param [in]     \c NULL or window Window for which the required Vulkan
 * instance extensions should be retrieved \param [in,out] pCount pointer to an
 * \c unsigned related to the number of required Vulkan instance extensions
 *  \param [out]    pNames \c NULL or a pointer to an array to be filled with
 * the required Vulkan instance extensions
 *
