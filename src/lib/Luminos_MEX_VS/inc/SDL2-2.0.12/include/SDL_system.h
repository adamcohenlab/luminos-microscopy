...
/**
   \brief Sets the UNIX nice value for a thread, using setpriority() if
   possible, and RealtimeKit if available.
...
/**
  \brief Return true is the application is running on a Samsung DeX docking
  station
 */
