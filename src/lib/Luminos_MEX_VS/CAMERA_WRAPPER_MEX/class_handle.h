/* Helper for handling passing of class instance handles between C++
and Matlab. Calling convertPtr2Mat on a valid C++ class instance pointer will
create a class_handle object, that can then be converted to a uint64 scalar and
passed to Matlab. 
Calling convertMat2Ptr on the resulting Matlab-compatible handle will convert it
back into a C++ pointer.*/
#pragma once
